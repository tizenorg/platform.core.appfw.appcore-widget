...
typedef int (*widget_instance_text_signal_cb) (widget_context_h context, const char *signal_name, const char *source, widget_obj_event_info_s * info, void *user_data);
